			...
			<div ref={sliderRef} className="keen-slider" style={{ width: "100%" }}>
				{dataSlider.map((slide, index) => (
					<div key={slide.id} className={`my-6 flex keen-slider__slide number-slide${index}`}>
						<div className="flex flex-col w-100 h-100 rounded-lg border border-solid border-[#D7DBE0] ">
							<div className="mb-6">
								<img className="object-cover  w-100 h-50" src={`${slide.img}`} alt="Placeholder" />
							</div>
							<div className="mx-6">
