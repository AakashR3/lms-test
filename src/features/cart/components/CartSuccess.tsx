...
export const CartSuccess = React.memo(() => (
	<main className="w-full flex h-full items-center justify-center">
		<div className="max-w-[26rem] text-center">
			<Icon icon="mingcute:check-circle-fill" className="w-32 h-32 text-success mx-auto" />
			<p className="pt-4 text-2xl font-semibold text-slate-800 dark:text-navy-50">Payment successful</p>
