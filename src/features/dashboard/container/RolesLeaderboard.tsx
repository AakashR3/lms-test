	...
	return (
		<div className="w-full h-full grid gap-4 xl:grid-cols-3 mb-6">
			<div className="w-full  flex flex-col px-6 py-6 rounded-lg bg-[#FFFFFF]  mx-[16px] xl:(col-span-2 mx-auto)">
				<span className="   leading-5 font-bold text-1xl   text-[#020A12BD]  ">Popular roles</span>
			...
			<div className="w-full flex flex-col px-[13px] py-4  rounded-lg bg-[#FFFFFF] mx-[16px]  xl:(mx-auto)">
