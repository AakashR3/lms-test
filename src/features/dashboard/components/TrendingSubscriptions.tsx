				...
				<div className="flex keen-slider overflow-hidden w-full">
					{trendingSubscription
						...
						.map((item: any, index: number) => (
							<div key={item.id} className={`bg-white px-5 py-5 mr-5  rounded-lg   `}>
								...
								<button className="btn bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90 w-full mt-6 py-3">
									<svg
										width="17"
										height="17"
										viewBox="0 0 17 17"
